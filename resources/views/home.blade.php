...
<div class="container">
	...
	<div class="card mt-3">
		<div class="card-body">
			...
			<button id="add" name="add" class="btn btn-info float-right mt-3 mb-3" data-toggle="modal" data-target="#create">
				Create
			</button>
			...
			<table class="table table-hover" id="gsrt">
				...
				<tbody id="surat_list" name="surat_list">
					...
					<tr id="surat">
						...
						<td>
							<button value="{{ $srt->id }}" class="btn btn-sm edit_modal">
								<i class="fas fa-edit"></i>
							</button>
							<button value="{{ $srt->id }}" class="btn btn-sm deletes">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form" name="form-data" id="form-data" novalidate="">
